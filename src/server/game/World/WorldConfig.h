...
enum ServerConfigs
{
    ...
    CONFIG_SKILL_GAIN_CRAFTING_HARDCORE,
    CONFIG_SKILL_GAIN_GATHERING_HARDCORE,
    ...
    RATE_HARDCORE_XP_KILL,
    RATE_HARDCORE_XP_QUEST,
    RATE_HARDCORE_XP_QUEST_DF,
    RATE_HARDCORE_XP_EXPLORE,
    RATE_HARDCORE_REPUTATION,
    RATE_REPAIRCOST,

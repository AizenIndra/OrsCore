...
void WorldConfig::BuildConfigCache()
{
    ...
    SetConfigValue<uint32>(CONFIG_CHARACTERS_PER_REALM, "CharactersPerRealm", 31, ConfigValueCache::Reloadable::Yes, [](uint32 const& value) { return value > 0 && value <= 31; }, "> 0 && <= 31");
    ...
    SetConfigValue<uint32>(CONFIG_HEROIC_CHARACTERS_PER_REALM, "HeroicCharactersPerRealm", 1, ConfigValueCache::Reloadable::Yes, [](uint32 const& value) { return value <= 31; }, "<= 31");

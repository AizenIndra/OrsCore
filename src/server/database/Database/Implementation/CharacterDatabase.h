...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_ONLINE_REWARDS,
    CHAR_INS_ONLINE_REWARDS,
    CHAR_UPD_ONLINE_REWARDS,
    CHAR_UPD_ONLINE_REWARDS_LOGIN,
    CHAR_UPD_ONLINE_REWARDS_REWARD,
